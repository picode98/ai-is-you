    ...
    def _input_state_tensor(self):
        while True:
            ...
            if len(item_parts) == 3 and item_parts[0] == 'unit_map':
                return (item_parts[1] == '1'), False, torch.tensor([[int(val) for val in unit.split(',')] for unit in item_parts[2].split(';')],
                                    dtype=torch.int64)
...
if __name__ == '__main__':
    ...
    model.env_feedback(biy_game.current_state, biy_game.game_won, biy_game.player_found)
